...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/gera0719/nov_fij_draw_logo/generate) / [`Create new repository`](https://github.com/gera0719/nov_fij_draw_logo/generate). 
...
- `nov_fij_draw_logo` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `gera0719` >> `mycoolusername`
